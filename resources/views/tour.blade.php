...
<body>
    ...
    <div class="tour-box">
        <img src="{{$tour[0]->image_url}}" alt="">
        <h1 style="font-size: 40px;margin:40px"> {{$tour[0]->title}} </h1>
        <p> {{$tour[0]->text}}</p>
        <p style="margin: 10px;font-size: 40px">  {{$tour[0]->cost}} GEL </p>
    </div>



        <a href="{{ route('AddTourToList', ['user_id' => Auth::id() ,
                                            'tour_id' => $tour[0]->id]) }}"> Add To Card </a>
